...
export class PaginationDto {
    ...
    @ApiPropertyOptional({ description: 'Sort by columns name', enum: OrderColumnsNameEnum })
    @IsOptional()
    ...
    @ApiPropertyOptional({ description: 'Filter by course format', enum: CourseFormatEnum })
    @IsOptional()
    @IsEnum(CourseFormatEnum)
    course_format?: CourseFormatEnum;

    @ApiPropertyOptional({ description: 'Filter by course type', enum: CourseTypeEnum })
    @IsOptional()
